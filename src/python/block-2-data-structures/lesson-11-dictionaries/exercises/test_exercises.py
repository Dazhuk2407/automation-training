"""
Автоматична перевірка вправ — Lesson 11: Dictionaries
...
EXERCISE_FILES = [
    ...
    "exercise_2_modification.py",
    "exercise_3_iteration.py",
    "exercise_4_test_data.py",
]
EXPECTED_TEST_COUNTS = {
    "exercise_1_basics.py": 5,
    "exercise_2_modification.py": 5,
    "exercise_3_iteration.py": 4,
