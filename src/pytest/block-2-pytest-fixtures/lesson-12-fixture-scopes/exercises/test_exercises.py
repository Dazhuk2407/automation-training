"""
Автоматична перевірка вправ — Lesson 12: Fixture Scopes
...
EXERCISE_FILES = [
    "exercise_1_scope.py",
    "exercise_2_shared_state.py",
    "exercise_3_fix_scope.py",
]

EXPECTED_TEST_COUNTS = {
    "exercise_1_scope.py": 5,
    "exercise_2_shared_state.py": 5,
    "exercise_3_fix_scope.py": 3,
}
