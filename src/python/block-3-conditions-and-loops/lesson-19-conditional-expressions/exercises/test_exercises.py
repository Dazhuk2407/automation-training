"""
Автоматична перевірка — Lesson 19: Conditional Expressions
Запуск: pytest test_exercises.py -v
"""
import ast, os, pytest

EXERCISES_DIR = os.path.dirname(os.path.abspath(__file__))
FILES = ["exercise_1_ternary.py", "exercise_2_or_defaults.py", "exercise_3_practical.py"]
EXPECTED = {"exercise_1_ternary.py": 4, "exercise_2_or_defaults.py": 3, "exercise_3_practical.py": 6}
