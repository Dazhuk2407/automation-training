"""
Автоматична перевірка вправ — Lesson 11: yield Fixtures
...
EXERCISE_FILES = [
    "exercise_1_yield.py",
    "exercise_2_cleanup.py",
    "exercise_3_fix_teardown.py",
]

EXPECTED_TEST_COUNTS = {
    "exercise_1_yield.py": 4,
    "exercise_2_cleanup.py": 4,
    "exercise_3_fix_teardown.py": 3,
}
