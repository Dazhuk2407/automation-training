"""
Автоматична перевірка вправ — Lesson 26: JUnit Report
...
EXERCISE_FILES = [
    "exercise_1_parse.py",
    "exercise_2_summary.py",
    "exercise_3_fix_report.py",
]

EXPECTED_TEST_COUNTS = {
    "exercise_1_parse.py": 5,
    "exercise_2_summary.py": 4,
    "exercise_3_fix_report.py": 3,
}
