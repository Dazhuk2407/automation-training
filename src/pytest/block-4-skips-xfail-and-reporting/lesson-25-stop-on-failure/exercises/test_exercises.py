"""
Автоматична перевірка вправ — Lesson 25: Stop on First Failure
...
EXERCISE_FILES = [
    "exercise_1_stop.py",
    "exercise_2_maxfail.py",
    "exercise_3_fix_stop.py",
]

EXPECTED_TEST_COUNTS = {
    "exercise_1_stop.py": 4,
    "exercise_2_maxfail.py": 4,
    "exercise_3_fix_stop.py": 3,
}
