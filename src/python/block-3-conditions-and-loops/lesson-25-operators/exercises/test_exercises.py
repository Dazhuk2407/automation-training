"""Автоматична перевірка — Lesson 25"""
import ast, os, pytest
D = os.path.dirname(os.path.abspath(__file__))
F = ["exercise_1_arithmetic.py", "exercise_2_logical.py", "exercise_3_practical.py"]
E = {"exercise_1_arithmetic.py": 4, "exercise_2_logical.py": 5, "exercise_3_practical.py": 4}
