"""
Автоматична перевірка — Lesson 16: range() та zip()
Запуск: pytest test_exercises.py -v
"""
import ast, os, pytest

EXERCISES_DIR = os.path.dirname(os.path.abspath(__file__))
FILES = ["exercise_1_range.py", "exercise_2_zip.py", "exercise_3_practical.py"]
EXPECTED = {"exercise_1_range.py": 4, "exercise_2_zip.py": 4, "exercise_3_practical.py": 3}
