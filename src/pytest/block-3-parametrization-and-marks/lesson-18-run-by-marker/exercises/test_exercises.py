"""
Автоматична перевірка вправ — Lesson 18: Run by Marker
...
EXERCISE_FILES = [
    "exercise_1_select.py",
    "exercise_2_expressions.py",
    "exercise_3_fix_selection.py",
]

EXPECTED_TEST_COUNTS = {
    "exercise_1_select.py": 5,
    "exercise_2_expressions.py": 5,
    "exercise_3_fix_selection.py": 3,
}
