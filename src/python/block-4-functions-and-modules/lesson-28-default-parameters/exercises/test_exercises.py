"""Автоматична перевірка — Lesson 28"""
import ast, os, pytest
D = os.path.dirname(os.path.abspath(__file__))
F = ["exercise_1_defaults.py", "exercise_2_mutable_fix.py", "exercise_3_builders.py"]
E = {"exercise_1_defaults.py": 4, "exercise_2_mutable_fix.py": 2, "exercise_3_builders.py": 4}
