"""Автоматична перевірка — Lesson 27: Arguments"""
import ast, os, pytest
D = os.path.dirname(os.path.abspath(__file__))
F = ["exercise_1_positional.py", "exercise_2_mixed.py", "exercise_3_helpers.py"]
E = {"exercise_1_positional.py": 3, "exercise_2_mixed.py": 3, "exercise_3_helpers.py": 4}
