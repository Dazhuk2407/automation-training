"""Автоматична перевірка — Lesson 23"""
import ast, os, pytest
D = os.path.dirname(os.path.abspath(__file__))
F = ["exercise_1_list_comp.py", "exercise_2_dict_set_comp.py", "exercise_3_practical.py"]
E = {"exercise_1_list_comp.py": 4, "exercise_2_dict_set_comp.py": 3, "exercise_3_practical.py": 3}
