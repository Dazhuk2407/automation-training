"""
Автоматична перевірка вправ — Lesson 14: Fixture Best Practices
...
EXERCISE_FILES = [
    "exercise_1_isolation.py",
    "exercise_2_refactor.py",
    "exercise_3_fix_practice.py",
]

EXPECTED_TEST_COUNTS = {
    "exercise_1_isolation.py": 5,
    "exercise_2_refactor.py": 5,
    "exercise_3_fix_practice.py": 2,
}
