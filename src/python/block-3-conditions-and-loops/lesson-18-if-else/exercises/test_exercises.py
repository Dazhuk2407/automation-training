"""
Автоматична перевірка — Lesson 18: if / else
Запуск: pytest test_exercises.py -v
"""
import ast, os, pytest

EXERCISES_DIR = os.path.dirname(os.path.abspath(__file__))
FILES = ["exercise_1_classify.py", "exercise_2_validate.py", "exercise_3_truthy.py", "exercise_4_boundaries.py"]
EXPECTED = {"exercise_1_classify.py": 6, "exercise_2_validate.py": 6, "exercise_3_truthy.py": 5, "exercise_4_boundaries.py": 3}
