"""
Автоматична перевірка вправ — Lesson 9: Fixture Basics
...
EXERCISE_FILES = [
    "exercise_1_define_fixture.py",
    "exercise_2_use_fixture.py",
    "exercise_3_fix_fixture.py",
]

EXPECTED_TEST_COUNTS = {
    "exercise_1_define_fixture.py": 5,
    "exercise_2_use_fixture.py": 5,
    "exercise_3_fix_fixture.py": 3,
}
