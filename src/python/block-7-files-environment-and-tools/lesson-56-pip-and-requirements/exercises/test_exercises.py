"""Автоматична перевірка — Lesson 56"""
import ast, os, pytest
D = os.path.dirname(os.path.abspath(__file__))
F = ["exercise_1_requirements.py", "exercise_2_fix_requirements.py"]
E = {"exercise_1_requirements.py": 5, "exercise_2_fix_requirements.py": 4}
