"""
Автоматична перевірка вправ — Lesson 13: conftest.py
...
EXERCISE_FILES = [
    "exercise_1_use_conftest.py",
    "exercise_2_combine.py",
    "exercise_3_fix_conftest.py",
]

EXPECTED_TEST_COUNTS = {
    "exercise_1_use_conftest.py": 5,
    "exercise_2_combine.py": 5,
    "exercise_3_fix_conftest.py": 3,
}
