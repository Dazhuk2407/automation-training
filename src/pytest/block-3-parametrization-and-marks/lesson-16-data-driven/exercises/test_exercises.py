"""
Автоматична перевірка вправ — Lesson 16: Data-Driven Testing
...
EXERCISE_FILES = [
    "exercise_1_datasets.py",
    "exercise_2_negative.py",
    "exercise_3_fix_data.py",
]

EXPECTED_TEST_COUNTS = {
    "exercise_1_datasets.py": 4,
    "exercise_2_negative.py": 4,
    "exercise_3_fix_data.py": 3,
}
...
class TestAssertsWritten:
    """Кожен тест містить assert/pytest.raises."""
...
class TestStudentTestsPass:
    """Тести студента проходять (exercise_3 — після виправлення даних)."""
