"""Автоматична перевірка — Lesson 26: Creating Functions"""
import ast, os, pytest
D = os.path.dirname(os.path.abspath(__file__))
F = ["exercise_1_basics.py", "exercise_2_helpers.py", "exercise_3_validation.py"]
E = {"exercise_1_basics.py": 5, "exercise_2_helpers.py": 3, "exercise_3_validation.py": 6}
