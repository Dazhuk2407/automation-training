"""
Автоматична перевірка вправ — Lesson 17: Markers
...
EXERCISE_FILES = [
    "exercise_1_apply_markers.py",
    "exercise_2_custom.py",
    "exercise_3_fix_marker.py",
]

EXPECTED_TEST_COUNTS = {
    "exercise_1_apply_markers.py": 5,
    "exercise_2_custom.py": 5,
    "exercise_3_fix_marker.py": 3,
}
