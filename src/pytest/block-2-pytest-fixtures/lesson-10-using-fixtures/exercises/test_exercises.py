"""
Автоматична перевірка вправ — Lesson 10: Using Fixtures
...
EXERCISE_FILES = [
    "exercise_1_pass_fixture.py",
    "exercise_2_multiple.py",
    "exercise_3_fix_usage.py",
]

EXPECTED_TEST_COUNTS = {
    "exercise_1_pass_fixture.py": 5,
    "exercise_2_multiple.py": 5,
    "exercise_3_fix_usage.py": 3,
}
