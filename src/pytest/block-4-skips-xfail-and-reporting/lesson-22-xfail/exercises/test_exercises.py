"""
Автоматична перевірка вправ — Lesson 22: xfail
...
EXERCISE_FILES = [
    "exercise_1_xfail.py",
    "exercise_2_conditions.py",
    "exercise_3_fix_xfail.py",
]

EXPECTED_TEST_COUNTS = {
    "exercise_1_xfail.py": 5,
    "exercise_2_conditions.py": 5,
    "exercise_3_fix_xfail.py": 3,
}
...
class TestTestCounts:
    """Кожен файл містить достатньо тестів."""
...
# ============================================================
# Тести проходять (0 failed; xfailed/xpassed — це не failure)
# ============================================================

class TestStudentTestsPass:
    """Тести студента не дають failure (xfailed/xpassed допустимі)."""
    ...
    def test_exercises_pass(self, filename):
        ...
        assert exit_code == 0, (
            f"Тести у {filename} дають failure. "
            f"Запустіть: pytest {filename} -rxX -v"
        )
