"""
Автоматична перевірка вправ — Lesson 21: Skip Tests
...
EXERCISE_FILES = [
    "exercise_1_skip.py",
    "exercise_2_skipif.py",
    "exercise_3_fix_skip.py",
]

EXPECTED_TEST_COUNTS = {
    "exercise_1_skip.py": 5,
    "exercise_2_skipif.py": 5,
    "exercise_3_fix_skip.py": 3,
}
...
# ============================================================
# Тести проходять (0 failures; SKIPPED дозволено)
# ============================================================

class TestStudentTestsPass:
    """Тести студента не падають (пропуски дозволені)."""
    ...
    def test_exercises_pass(self, filename):
        ...
        assert exit_code == 0, (
            f"Тести у {filename} не проходять (є failures). "
