"""
Автоматична перевірка вправ — Lesson 6: Assertions
...
EXERCISE_FILES = [
    "exercise_1_comparison.py",
    "exercise_2_types_and_membership.py",
    "exercise_3_exceptions.py",
    "exercise_4_messages.py",
    "exercise_5_introspection.py",
]

EXPECTED_TEST_COUNTS = {
    "exercise_1_comparison.py": 6,
    "exercise_2_types_and_membership.py": 6,
    "exercise_3_exceptions.py": 4,
    "exercise_4_messages.py": 3,
    "exercise_5_introspection.py": 2,
}
