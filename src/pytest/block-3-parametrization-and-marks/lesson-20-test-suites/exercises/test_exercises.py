"""
Автоматична перевірка вправ — Lesson 20: Test Suites
...
EXERCISE_FILES = [
    "exercise_1_suite.py",
    "exercise_2_organize.py",
    "exercise_3_fix_suite.py",
]

EXPECTED_TEST_COUNTS = {
    "exercise_1_suite.py": 5,
    "exercise_2_organize.py": 5,
    "exercise_3_fix_suite.py": 3,
}
