"""
Автоматична перевірка вправ — Lesson 12: Safe Dictionary Access
...
EXERCISE_FILES = [
    "exercise_1_get_basics.py",
    "exercise_2_nested.py",
    "exercise_3_real_scenarios.py",
    "exercise_4_setdefault.py",
]
EXPECTED_TEST_COUNTS = {
    "exercise_1_get_basics.py": 5,
    "exercise_2_nested.py": 3,
    "exercise_3_real_scenarios.py": 4,
    "exercise_4_setdefault.py": 3,
}
