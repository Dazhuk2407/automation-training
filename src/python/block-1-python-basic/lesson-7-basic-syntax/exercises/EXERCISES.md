...
## 🏋️ Завдання 4: Множественне присвоювання (MEDIUM)

Створіть файл `exercise_4_multiple_assignment.py`:

```python
"""Вправа на множественне присвоювання та swap."""

# TODO: Присвоїте три змінні одночасно
# x, y, z = ...

# TODO: Виведіть їхні значення

# TODO: Помініяйте значення x та y (swap)
...
## 🏋️ Завдання 6: Виявлення синтаксичних помилок (MEDIUM)
...
**Готові до наступного уроку?** Якщо виконали 5+ вправ - так! 🚀
