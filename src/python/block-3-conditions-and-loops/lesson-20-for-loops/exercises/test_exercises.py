"""Автоматична перевірка — Lesson 20: for Loops"""
import ast, os, pytest
EXERCISES_DIR = os.path.dirname(os.path.abspath(__file__))
FILES = ["exercise_1_basics.py", "exercise_2_collecting.py", "exercise_3_nested.py", "exercise_4_test_data.py"]
EXPECTED = {"exercise_1_basics.py": 4, "exercise_2_collecting.py": 3, "exercise_3_nested.py": 3, "exercise_4_test_data.py": 3}
