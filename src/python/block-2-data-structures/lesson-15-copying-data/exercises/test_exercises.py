"""
Автоматична перевірка — Lesson 15: Copying Data
Запуск: pytest test_exercises.py -v
"""
import ast, os, pytest

EXERCISES_DIR = os.path.dirname(os.path.abspath(__file__))
FILES = ["exercise_1_shallow.py", "exercise_2_deep.py", "exercise_3_test_data.py"]
EXPECTED = {"exercise_1_shallow.py": 3, "exercise_2_deep.py": 3, "exercise_3_test_data.py": 3}
