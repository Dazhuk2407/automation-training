...
Це посібник для першого запуску проєкту та вибору курсу для навчання.
...
```bash
cd src/pytest/block-0-pytest-basic/lesson-1/
cat README.md
```
...
1. **Не поспішайте** - виділяйте 1-2 години на один урок
2. **Практикуйте код** - перипишіть приклади самостійно
3. **Відповідайте на питання** - перевіряйте своє розуміння
4. **Експериментуйте** - модифікуйте код та побачите результати
5. **Не пропускайте** - кожна тема будує на попередній
